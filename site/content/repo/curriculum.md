...
Progression here is not exponential.
It is **orthogonal**.
...
At no point is a previous dimension relaxed.
Each new course adds pressure without removing responsibility.

This is intentional.

Understanding is not accumulated by explanation.
It is earned by surviving constraints.
...
The goal is not fluency in tools.
The goal is **durable judgment**.
...
Dipole does not explain systems.
It exposes them.
